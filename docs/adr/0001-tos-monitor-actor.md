...
This repository archives the publicly published Terms of Use of Siemens
Healthineers AG, per ADR-2607110300 -- a read-only reference archive. As
part of a 10-repo validation batch extending the
...
- **Company**: Siemens Healthineers AG, LEI 529900QBVWXMWANH7H45, website
  `https://www.siemens-healthineers.com`.
- **Baseline provenance** (real, from this repo's own `80-data/public/
  tos.journal.edn`): source-url
  `https://www.siemens-healthineers.com/corporate/terms-of-use`,
...
Same as the pilot (ADR-2607241900) and the batch (ADR-2607242000).
